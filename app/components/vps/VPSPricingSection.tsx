              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6">
                <div className="flex items-center gap-4">
                  <div className="relative w-12 h-12 rounded-md">
                    <Image
                      src={plan.image || "/icons/nodejs.png"}
                      alt="CPU"
                      fill
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  <div className="text-center sm:text-right">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">{plan.period}</div>
                  </div>
                  <a
                    href={`/checkout/vps/${plan.id}`}
                    className="orbitron-font w-full sm:w-auto card-primary hover:opacity-90 icon-text-primary px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm border border-secondary"
                  >
                    <span>{t('vps.configure')}</span>
